...
- **Reste non passé au banc** (build + smoke-tests seulement) : le **Garage 3D fly-to** (WebGL logiciel, non rendu ici) et le **panneau extension** (pas un composant App). Faible risque (try/catch), mais à confirmer visuellement au prochain vrai usage.
